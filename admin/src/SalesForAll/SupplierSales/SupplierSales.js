      ...
      <div style={{ display: 'flex' , backgroundColor:'white'}}>
        <div>
          <div style={{ display: 'flex' }}>
            <img src={`https://static.remove.bg/remove-bg-web/36b50c4385f75bb65509f63b1e81f99fe2b334fc/assets/start_remove-c851bdf8d3127a24e2d137a55b1b427378cd17385b01aec6e59d5d4b5f39d2ec.png`} style={{ width: 220, height: 220, borderRadius: 0 }} alt="" />
