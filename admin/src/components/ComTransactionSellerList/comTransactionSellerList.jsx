import "./comtransactionsellerlist.css";
...
export default function ComTransactionSellerList() {
  ...
  useEffect(() => {
    const getOrder = async()=>{
      try {
        const res = await axios.get(`https://api.aavelance.com/api/transfer/completed/transaction/for/mainAdmin`, {
          headers:{
            token: accessToken
          }
        })
