...
export default function Follow({userdetails}) {
  ...
  console.log(id);
    ...
    const handleFollow= async(e)=>{
            await fetch(`http://172.232.73.46:80/api/user/feed/following/${userdetails._id}` , {method:'PUT', headers:{'Content-Type':"application/JSON" , token:accessToken} , body:JSON.stringify({user:`${id}`})})
