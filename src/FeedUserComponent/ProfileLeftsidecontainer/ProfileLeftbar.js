...
export default function ProfileLeftbar() {
  ...
  const handleFollow = async()=>{
    if(Follow === "Follow"){
      await fetch(`https://api.aavelance.com/api/user/following/${id}` , {method:'PUT', headers:{'Content-Type':"application/JSON" , token:accessToken} , body:JSON.stringify({user:`${user.other._id}`})})
