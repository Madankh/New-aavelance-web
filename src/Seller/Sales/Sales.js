...
export default function Sales() {
  ...
  useEffect(() => {
    const PreviousTotSales = async () => {
      try {
        const res = await axios.get('http://api.aavelance.com/api/order/get/previos/one/week/userOrder', {
          headers: {
            token: accessToken
          }
        })
  ...
  useEffect(() => {
    const PreviousTwotSales = async () => {
      try {
        const res = await axios.get('http://api.aavelance.com/api/order/get/two/weeks/userOrder', {
          headers: {
            token: accessToken
          }
        })
  ...
  useEffect(() => {
    const PreviousThreetSales = async () => {
      try {
        const res = await axios.get('http://api.aavelance.com/api/order/get/previous/three/weeks/userOrder', {
          headers: {
            token: accessToken
          }
        })
  ...
  useEffect(() => {
    const PreviousFourtSales = async () => {
      try {
        const res = await axios.get('http://api.aavelance.com/api/order/get/previous/four/weeks/userOrder', {
          headers: {
            token: accessToken
          }
        })
  ...
  useEffect(() => {
    const OnemonthTotSales = async () => {
      try {
        const res = await axios.get('http://api.aavelance.com/api/order/get/one/month/userOrder', {
          headers: {
            token: accessToken
          }
        })
