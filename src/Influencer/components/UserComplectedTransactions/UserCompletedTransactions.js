...
export default function UserCompletedTransactions() {
    ...
    useEffect(() => {
        const getTransaction = async ()=>{
            try {
                const res = await axios.get(`http://192.168.18.4:5000/api/influencer/transaction/get/status/complected/transaction`,
               { headers:{
                  token: accessToken
                }})
